...
- [~] NFR Design — **진행 중·리뷰 게이트 (2026-06-19)**. 계획서 `construction/plans/u7-summarization-nfr-design-plan.md`(질문 게이트). 스트리밍/근거화/캐시/저하 복원력 패턴·논리 컴포넌트·구체 서킷/타임아웃 수치·CI 레인 확정 예정. 산출물·코드 미생성(답변 대기).
