...
- [x] **C-V4. 최종 리뷰 요청** — 2026-06-10 사용자 확정: "도메인 모델도 지금 그대로 확정". [`component-model.md`](../design-artifacts/component-model.md) 헤더에 동결 표기, 이후 변경은 handoff §6 4단계. **본 계획의 전 단계 완료.**
