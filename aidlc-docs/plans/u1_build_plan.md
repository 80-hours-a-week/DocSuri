...
- [ ] **D3. 사용자 최종 리뷰** — 코드·테스트 결과 제출, 피드백 대기.

### Part E — 마무리
- [x] **E1. README** — U1 모듈·엔드포인트·실행법 추가.
- [ ] **E2. 커밋/PR** — 사용자 승인 시 U0 stacked PR 위에 U1.

---

## 범위 밖 (다음 라운드)

- 프론트엔드(Next.js App Router + shadcn/ui) — ResultListView·검색폼·결과카드 데스크톱6/모바일3·"더 보기" 펼침·바텀시트·필터 칩·URL 직렬화 UI 적용([NFR-UX-03](../requirements/nfr.md#nfr-ux-03)·[NFR-MOBILE-01·04](../requirements/nfr.md#nfr-mobile-01)·[NFR-A11Y-01](../requirements/nfr.md#nfr-a11y-01)).
