...
| --- | --- | --- |
| U11 unit tests | `python -m pytest backend/tests/test_novelty.py -q` | 10 passed |
| U11 + app-shell | `$env:PYTHONPATH='shared/python/src;ops/src;backend/modules/discovery/src;backend/modules/summarization/src'; python -m pytest backend/tests/test_novelty.py backend/tests/test_app_shell.py -q` | 24 passed |
