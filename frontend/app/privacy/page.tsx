  ...
  return (
    <div className={styles.screen}>
      ...
      <p className={styles.updated}>
        시행일: <span className={styles.todo}>[[YYYY-MM-DD 채우기]]</span> · 최종 개정일:{' '}
        <span className={styles.todo}>[[YYYY-MM-DD 채우기]]</span>
      </p>
      <p className={styles.draftNote}>
        ※ 초안입니다. 아래 <span className={styles.todo}>[[…]]</span> 항목(운영주체 정보·보호책임자
        연락처·수탁사 리전·보유기간 등)은 법무 검토 후 확정해야 합니다.
      </p>

      <p className={styles.body}>
        <span className={styles.todo}>[[운영주체 법인명]]</span>(이하 “회사”)은 「개인정보 보호법」 등
        관련 법령을 준수하며, DocSuri(이하 “서비스”) 이용자의 개인정보를 다음과 같이 처리합니다.
      </p>
      ...
      <ul className={styles.list}>
        ...
        <li>
          소셜 로그인(Google): OpenID 인증 시 <strong>openid, email</strong> 범위로 이메일 주소와 Google
          계정 식별자(sub)를 전달받습니다. 이름·프로필 사진 등 그 밖의 Google 계정 정보는 수집하지
          않습니다.
        </li>
        <li>
        ...
        <li>
          서비스 이용 과정에서 자동 생성·수집: 검색어, 조회한 논문, 라이브러리 저장 등 이용 이벤트(개인화
          제공 목적), 접속 로그, 세션 쿠키
        </li>
      </ul>
      ...
      <p className={styles.body}>
        회원 탈퇴 시 계정을 비활성화(소프트 삭제)한 뒤 <span className={styles.todo}>[[유예 기간:
        30일]]</span> 경과 후 파기합니다. 다만 관련 법령에 따라 보존이 필요한 정보는 해당 기간 동안
        보관하며, 백업 보관 기간은 <span className={styles.todo}>[[보관 정책 확정: 30일 유예 vs 5년
        백업 상충 해소 필요]]</span>.
      </p>

      <h2 className={styles.h2}>4. 개인정보의 제3자 제공</h2>
      <p className={styles.body}>
        회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않으며, 법령에 근거하거나 이용자의 동의가
        있는 경우에 한하여 제공합니다.
      </p>
      ...
      <p className={styles.body}>
        이용자는 언제든지 개인정보 열람·정정·삭제·처리정지를 요구할 수 있으며, 마이페이지에서 동의 철회
        및 회원 탈퇴를 직접 수행할 수 있습니다.
      </p>
      ...
      <p className={styles.body}>
        서비스는 로그인 세션 유지를 위해 httpOnly 세션 쿠키를 사용합니다. 이용자는 브라우저 설정을 통해
        쿠키 저장을 거부할 수 있으나, 이 경우 로그인이 제한될 수 있습니다.
      </p>

      <h2 className={styles.h2}>10. 개인정보 보호책임자</h2>
      <ul className={styles.list}>
        <li>성명/직책: <span className={styles.todo}>[[보호책임자 성명·직책]]</span></li>
        <li>연락처(이메일): <span className={styles.todo}>[[문의 이메일]]</span></li>
      </ul>
