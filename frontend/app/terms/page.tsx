  ...
  return (
    <div className={styles.screen}>
      ...
      <p className={styles.updated}>
        시행일: <span className={styles.todo}>[[YYYY-MM-DD 채우기]]</span>
      </p>
      <p className={styles.draftNote}>
        ※ 초안입니다. <span className={styles.todo}>[[…]]</span> 항목(운영주체·준거법·문의처)은 법무
        검토 후 확정해야 합니다.
      </p>

      <h2 className={styles.h2}>제1조 (목적)</h2>
      <p className={styles.body}>
        본 약관은 <span className={styles.todo}>[[운영주체 법인명]]</span>(이하 “회사”)이 제공하는
        DocSuri(이하 “서비스”)의 이용 조건 및 절차, 회사와 이용자의 권리·의무를 정함을 목적으로 합니다.
      </p>

      <h2 className={styles.h2}>제2조 (정의)</h2>
      <ul className={styles.list}>
        <li>“서비스”란 AI·머신러닝 분야 arXiv 논문을 검색·요약·번역하고 근거를 제시하는 웹 서비스를 말합니다.</li>
      ...
      <p className={styles.body}>
        ...
        약관을 변경할 수 있으며, 변경 시 시행일 및 사유를 명시하여 사전 공지합니다.
      </p>

      <h2 className={styles.h2}>제4조 (서비스의 내용)</h2>
      <p className={styles.body}>
        회사는 논문 검색, 핵심 요약, 번역, 근거(grounding) 표시, 라이브러리 저장, 개인화 추천 등의 기능을
        제공합니다. 서비스의 구체적 내용은 회사의 정책에 따라 변경될 수 있습니다.
      </p>
      ...
      <p className={styles.body}>
        서비스가 제공하는 논문 원문의 저작권은 arXiv 및 원저작자 등 정당한 권리자에게 귀속되며, 서비스는
        이를 학술적 참고 목적으로 제공합니다. 서비스 자체의 상표·디자인·소프트웨어에 대한 권리는 회사에
        귀속됩니다.
      </p>

      <h2 className={styles.h2}>제8조 (면책)</h2>
      <p className={styles.body}>
        AI가 생성하는 요약·번역·근거 표시는 참고용이며 정확성·완전성을 보증하지 않습니다. 이용자는 학술적
        판단 시 반드시 원문을 확인해야 하며, 회사는 이를 신뢰하여 발생한 결과에 대해 책임을 지지 않습니다.
      </p>

      <h2 className={styles.h2}>제9조 (서비스의 중단·변경)</h2>
      <p className={styles.body}>
        회사는 시스템 점검, 장애, 불가항력 등의 사유로 서비스의 전부 또는 일부를 일시 중단하거나 변경할 수
        있으며, 가능한 경우 사전에 공지합니다.
      </p>

      <h2 className={styles.h2}>제10조 (회원 탈퇴 및 이용제한)</h2>
      <p className={styles.body}>
        이용자는 마이페이지에서 언제든지 회원 탈퇴를 할 수 있습니다. 회사는 이용자가 본 약관을 위반한
        경우 서비스 이용을 제한하거나 계약을 해지할 수 있습니다.
      </p>

      <h2 className={styles.h2}>제11조 (준거법 및 관할)</h2>
      <p className={styles.body}>
        본 약관은 <span className={styles.todo}>[[준거법: 대한민국 법]]</span>에 따라 규율되며, 서비스와
        관련한 분쟁은 <span className={styles.todo}>[[관할 법원]]</span>을 관할 법원으로 합니다.
      </p>
